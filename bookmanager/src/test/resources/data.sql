...
call next value for hibernate_sequence;
insert into member(`id`,`name`,`email`,`created_at`,`updated_at`) values (4,'khs4','khs4@naver.com',now(),now());

call next value for hibernate_sequence;
insert into member(`id`,`name`,`email`,`created_at`,`updated_at`) values (5,'khs','khs5@naver.com',now(),now());